...
export default class TVShowDetailsModel extends base_model {
	constructor(options) {
		super();
		this.url = "https://api.themoviedb.org/3/tv/" + options.id + "?api_key=cad193d8b6b642176344ffe8d4219062";
		this.type = "tv_details";
		this.initialize();
	}
	initialize() {
	}
